...
# fall back to -march=armv8.2-a in case the compiler isn't
# compatible with -mcpu
ARM_ARCH_OPT := -mcpu=cortex-a75.cortex-a55+crypto
GEN_OPT_FLAGS := $(call cc-option,$(ARM_ARCH_OPT),-march=armv8.2-a+crypto) \
 -g0 -DNDEBUG \
 -fivopts $(MK_FLAGS)
